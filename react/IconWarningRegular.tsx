...
const IconWarningRegular = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <g>
      <g>
        <path
          d="M12 7.10204C12.4508 7.10204 12.8163 7.46752 12.8163 7.91837V12.5102C12.8163 12.961 12.4508 13.3265 12 13.3265C11.5492 13.3265 11.1837 12.961 11.1837 12.5102V7.91837C11.1837 7.46752 11.5492 7.10204 12 7.10204Z"
          fill="currentColor"
        />
        <path
