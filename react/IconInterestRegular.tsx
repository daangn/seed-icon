    ...
    <g>
      <g>
        ...
        <path
          fillRule="evenodd"
          clipRule="evenodd"
          d="M17.1353 10.0877C16.8132 9.33618 15.7477 9.33619 15.4257 10.0877L14.3566 12.5822L11.8836 12.874C11.1194 12.9642 10.7891 13.8905 11.3239 14.4439L13.1422 16.3254L12.7174 18.8378C12.5826 19.6356 13.4603 20.2131 14.1396 19.7737L16.2805 18.3887L18.4213 19.7737C19.1007 20.2131 19.9783 19.6356 19.8435 18.8378L19.4188 16.3254L21.237 14.4439C21.7718 13.8905 21.4415 12.9642 20.6773 12.874L18.2043 12.5822L17.1353 10.0877ZM15.7161 13.624L16.2805 12.3072L16.8448 13.624C16.9758 13.9298 17.2602 14.1423 17.5906 14.1813L19.0194 14.3499L17.9687 15.4371C17.7634 15.6496 17.6712 15.947 17.7205 16.2384L17.9302 17.4789L16.7856 16.7385C16.4782 16.5396 16.0827 16.5396 15.7753 16.7385L14.6307 17.4789L14.8404 16.2384C14.8897 15.947 14.7975 15.6496 14.5922 15.4371L13.5415 14.3499L14.9703 14.1813C15.3007 14.1423 15.5851 13.9298 15.7161 13.624Z"
          fill="currentColor"
        />
        <path
...
export default React.forwardRef(IconInterestRegular);
