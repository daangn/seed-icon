    ...
    <g>
      <g>
        ...
        <path
          fillRule="evenodd"
          clipRule="evenodd"
          d="M15.7 18.6C15.7 18.2686 15.9686 18 16.3 18H20.8C21.1313 18 21.4 18.2686 21.4 18.6C21.3999 18.9314 21.1313 19.2 20.8 19.2H16.3C15.9686 19.2 15.7 18.9314 15.7 18.6Z"
          fill="currentColor"
        />
        <path
          fillRule="evenodd"
          clipRule="evenodd"
          d="M18.2242 15.1757C17.9899 14.9414 17.61 14.9414 17.3756 15.1757L14.3756 18.1757C14.1413 18.4101 14.1413 18.79 14.3756 19.0243L17.3756 22.0243C17.61 22.2586 17.9899 22.2586 18.2242 22.0243C18.4585 21.79 18.4585 21.4101 18.2242 21.1757L15.6484 18.6L18.2242 16.0243C18.4585 15.7899 18.4585 15.4101 18.2242 15.1757Z"
          fill="currentColor"
        />
      </g>
    </g>
