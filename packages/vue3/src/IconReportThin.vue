...
<g id="Weight=Thin">
<g id="vector">
<path d="M16.4999 11.8999C16.8313 11.8999 17.0999 12.1685 17.0999 12.4999C17.0999 12.8313 16.8313 13.0999 16.4999 13.0999C16.1685 13.0999 15.8999 12.8313 15.8999 12.4999C15.8999 12.1685 16.1685 11.8999 16.4999 11.8999Z" fill="#212124"/>
...
<path fill-rule="evenodd" clip-rule="evenodd" d="M12 3.3999C7.99594 3.3999 4.75 6.64584 4.75 10.6499V16.8H4.1399C3.73121 16.8 3.3999 17.1314 3.3999 17.54V20.06C3.3999 20.4687 3.73121 20.8 4.1399 20.8H19.8599C20.2686 20.8 20.5999 20.4687 20.5999 20.06V17.54C20.5999 17.1314 20.2686 16.8 19.8599 16.8H19.25V10.6499C19.25 6.64584 16.0041 3.3999 12 3.3999ZM18.05 16.8V10.6499C18.05 7.30858 15.3413 4.5999 12 4.5999C8.65868 4.5999 5.95 7.30858 5.95 10.6499V16.8H18.05ZM4.5999 19.6V18H19.3999V19.6H4.5999Z" fill="#212124"/>
</g>
</g>
</svg>
</template>
